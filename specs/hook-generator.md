...
- `selected`: int | None. 채택된 후보 인덱스. 현재는 0번을 자동 채택한다(후보 확인·선택
  HITL은 향후, [../docs/Retrospective.md](../docs/Retrospective.md)).
...
- **채택**: 현재는 후보 0번을 자동 채택한다. 사람이 후보를 확인·편집·선택하는 HITL은
  향후 과제다([../docs/Retrospective.md](../docs/Retrospective.md)).
...
- 후보 0번 자동 채택 결과가 스토리보드 0번 패널로 펼쳐진다.
