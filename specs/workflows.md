...
> 아래 본문(머메이드·노드 서술·로드맵)은 이 개정에 맞춰 갱신됐다. verify는 하드 게이트 +
> repair 유한 루프로 구현됐다(loudness 재믹싱, 최대 3회). 미룬 항목(그래프 안 노드별 HITL
> 게이트 등)은 [../docs/Retrospective.md](../docs/Retrospective.md) 3절에 정리한다.
